...
import {
  cdpMeta,
  cdpCoreCapabilities as coreCapabilities,
  cdpIntegrations as integrations,
  cdpFaqs,
} from "@/lib/page-content/cdp";

export const metadata: Metadata = {
  title: cdpMeta.title,
  description: cdpMeta.description,
  alternates: mdAlternateFor("/platform/cdp"),
};
...
export default function CdpPage() {
  return (
    <>
      ...
      <FAQList title="What buyers ask us" items={cdpFaqs} />
